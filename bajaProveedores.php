<?php
	...
	/*El codigo de arriba obtiene mediante un id a un proveedor el cual posteriormente se muestra 
	en una tabla.*/
	$res=$db->query($query);
	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='proveedores.php'"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span> Proovedores</li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Baja proveedor</h1>
				</br>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><?php echo $var['Nombre_proveedor']?></td>
					</tr>
					<tr>
				...
				<br/>
		    	<a href="proveedores.php" class="btn btn-danger active" role="button">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <?php echo '<button type="button" class="btn btn-success active" onclick="location.href ='."'baja.php?caso=proveedor&";?>
