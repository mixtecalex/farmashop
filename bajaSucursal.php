<?php
	...
	$db=conexionBase();
	$query = "SELECT * FROM sucursal WHERE id=".$_GET['id'];
	$res=$db->query($query);
	/*El codigo de arriba obtiene mediante un id a una sucursal la cual posteriormente se muestra 
	en una tabla.*/
	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='sucursales.php'"><span class="glyphicon glyphicon-folder-close" aria-hidden="true"></span> Sucursales</li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Baja sucursal</h1>
				</br>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><?php echo $var['latitud_Mapa']; ?></td>
					</tr>
					<tr>
						<td><strong>Logitud: </strong></td>
						<td><?php echo $var['longitud_Mapa']; ?></td>
					</tr>
					<tr>
						<td><strong>Entrada: </strong></td>
						<td><?php echo $var['horario_entrada']; ?></td>
					</tr>
					<tr>
						<td><strong>Salida: </strong></td>
						<td><?php echo $var['horario_salida']; ?></td>
					</tr>
				</table>

				<br/>
		    	<a href="sucursales.php" class="btn btn-danger active" role="button">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <?php echo '<button type="button" class="btn btn-success active" onclick="location.href ='."'baja.php?caso=sucursal&";?>
