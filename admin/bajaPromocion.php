<?php
	...
	$query = "SELECT * FROM promocion WHERE id=".$_GET['id'];
	$res=$db->query($query);
	/*El codigo de arriba obtiene mediante un id a una promocion la cual posteriormente se muestra 
	en una tabla.*/
	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='promociones.php'"><span class="glyphicon glyphicon-gift" aria-hidden="true"></span> Promociones</li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Baja promoción</h1>
				</br>
				<table class="table">
					<tr>
						<td><strong>N° de Lote: </strong></td>
						<td><?php echo $var["Id_lote"];?></td>
					</tr>
					<tr>
						<td><strong>% de Descuento: </strong></td>
						<td><?php echo $var["porcentaje_descuento"];?></td>
					</tr>
					<tr>
						<td><strong>Fecha de Inicio de la Promoción:</strong></td>
						<td><?php echo $var["Fecha_inicio"];?></td>
					</tr>
					<tr>
						<td><strong>Fecha de Termino de la Promoción: </strong></td>
						<td><?php echo $var["Fecha_termino"];?></td>
					</tr>
				</table>

				<br/>
		    	<a href="promociones.php" class="btn btn-danger active" role="button">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <?php echo '<button type="button" class="btn btn-success active" onclick="location.href ='."'baja.php?caso=promocion&";?>
