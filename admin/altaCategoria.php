	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='lotes.html'"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Categorías</li>
					<li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Alta categoría</h1>
				</br>
				...
				<form class="form-horizontal">
			  	<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      	<input type="value="Algo por aqui algo por alla"" class="form-control" id="inputEmail3" placeholder="Nombre de la nueva categoría">
			    	</div>
				</div>
