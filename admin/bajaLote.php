<?php
	...
	$db=conexionBase();
	$query = "SELECT * FROM lote WHERE id=".$_GET['id'];
	$res=$db->query($query);
	/*El codigo de arriba obtiene mediante un id a un lote la cual posteriormente se muestra 
	en una tabla.*/
		...
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='lotes.php'"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> Lotes</li>
			...
			<div class="formulario">
				...
				<table class="table">
					...
					<tr>
						...
						<td><?php echo $var['Id_producto'];?></td>
					</tr>
					<tr>
						<td><strong>Sucursal: </strong></td>
						<td><?php echo $var['Id_sucursal'];?></td>
					</tr>
					<tr>
						<td><strong>N° de Productos: </strong></td>
						<td><?php echo $var['Cantidad'] ?></td>
					</tr>
					<tr>
						<td><strong>Fecha de Caducidad: </strong></td>
						<td><?php echo $var['Fecha_de_caducidad']; ?></td>
					</tr>
				</table>

				<a href="lotes.php" class="btn btn-danger active" role="button">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <?php echo '<button type="button" class="btn btn-success active" onclick="location.href ='."'baja.php?caso=lote&";?>
