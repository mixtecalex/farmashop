		...
		<div class="contenido">
			<div class="formulario">
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-10">
				    	<input type="text" value="Algo por aqui algo por alla" class="form-control" id="inputtext3" placeholder="Conpuesto">
					</div>		
				</div>
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">Precio:</label>
				    <div class="col-sm-10">
				    	<input type="text" value="Algo por aqui algo por alla" class="form-control" id="inputtext3" placeholder="Precio">
					</div>		
				</div>
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">Descripción:</label>
				    <div class="col-sm-10">
				    	<input type="text" value="Algo por aqui algo por alla" class="form-control" id="inputtext3" placeholder="Descripción">
					</div>		
				</div>
				<div class="form-group">
