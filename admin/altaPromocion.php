	...
	<body>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Alta promoción</h1>
				</br>
				...
				<form class="form-horizontal">
			  	<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      	<input type="value="Algo por aqui algo por alla"" class="form-control" id="inputEmail3" placeholder="N° de Lote">
			    	</div>
				</div>
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">% de Descuento:</label>
				    <div class="col-sm-10">
				    	<input type="text" class="form-control" id="inputtext3" placeholder="% de Descuento">
					</div>		
				</div>
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">Fecha de Inicio de la Promoción:</label>
				    <div class="col-sm-10">
				    	<input type="date" class="form-control" id="inputtext3" placeholder="Dirección">
					</div>		
				</div>
				<div class="form-group">
				   <label for="inputtext3" class="col-sm-2 control-label">Fecha de Termino de la Promoción:</label>
				    <div class="col-sm-10">
				    	<input type="date" class="form-control" id="inputtext3" placeholder="Dirección">
					</div>		
				</div>
