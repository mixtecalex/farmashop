	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='sucursales.html'"><span class="glyphicon glyphicon-folder-close" aria-hidden="true"></span> Sucursales</li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Modificar sucursal</h1>
				</br>
				...
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">Horario:</label>
				    <div class="col-sm-10">
				    	<input type="text" value="Algo por aqui algo por alla" class="form-control" id="inputtext3" placeholder="Horario">
					</div>		
				</div>
				<div class="form-group">
				    <label for="inputtext3" class="col-sm-2 control-label">Mapa:</label>
				    <div class="col-sm-10">
				    	<img src="img/mapa.png" class="img-thumbnail">
					</div>		
				</div>
