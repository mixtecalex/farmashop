<?php
	...
	$res=$db->query($query);
	/*El codigo de arriba obtiene mediante un id a un usuario el cual posteriormente se muestra 
	en una tabla.*/
	...
	<body>
		<header>
			<nav>
				...
				<ul>
					...
					<li class="elementoMenuActivo" onclick="location.href ='usuarios.php'"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Usuarios</li>
		...
		<div class="contenido">
			<div class="formulario">
				...
				<h1 class="titulo">Baja usuario</h1>
				</br>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><?php echo $var['Sucursal']?></td>
					</tr>
					<tr>
						<td><strong>Foto: </strong></td>
						<td><img src="<?php echo $var['Foto'];?>" alt="..." class="img-rounded imagenBajaProducto"></td>
					</tr>

				</table>

				<br/>
		    	<a href="usuarios.php" class="btn btn-danger active" role="button">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <?php echo '<button type="button" class="btn btn-success active" onclick="location.href ='."'baja.php?caso=usuario&";?>
