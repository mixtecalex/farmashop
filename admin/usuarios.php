	...
	<body>
		...
		<div class="contenido">
			<div class="tablas">
				...
				<!-- <a href="#" class="btn btn-success" role="button"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Nuevo</a> -->
				<center>
					<a href="#" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar usuario</a>
				</center>
				</br>
				<table class="table">
				<thead>
